...
def Update():
    ...
    work_countdown = settime_work - elapsedtime
    mins_work = int(work_countdown/60)
    secs_work = int(work_countdown - mins_work*60)
    rest_countdown = settime_rest + work_countdown
    mins_rest = int(rest_countdown/60)
    secs_rest = int(rest_countdown - mins_rest*60)
    if work_countdown <= 0:
        ifrest = True
        if rest_countdown >= 0:
